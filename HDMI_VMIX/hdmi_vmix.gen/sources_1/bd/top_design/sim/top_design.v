...
(* CORE_GENERATION_INFO = "top_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=20,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=15,da_board_cnt=5,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "top_design.hwdef" *) 
module top_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [7:0]axi_smc_M06_AXI_ARADDR;
  wire axi_smc_M06_AXI_ARREADY;
  wire axi_smc_M06_AXI_ARVALID;
  wire [7:0]axi_smc_M06_AXI_AWADDR;
  ...
  assign ilconcat_0_dout = {v_tpg_0_interrupt, v_frmbuf_wr_0_interrupt, v_frmbuf_rd_0_interrupt, v_tc_0_irq};
  assign HDMI_EN = 1'h1;
  ...
  top_design_v_mix_0_0 v_mix_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        ...
        .s_axis_video1_TDATA(v_frmbuf_rd_0_m_axis_video_TDATA),
        .s_axis_video1_TDEST(v_frmbuf_rd_0_m_axis_video_TDEST),
        .s_axis_video1_TID(v_frmbuf_rd_0_m_axis_video_TID),
        .s_axis_video1_TKEEP(v_frmbuf_rd_0_m_axis_video_TKEEP),
        .s_axis_video1_TLAST(v_frmbuf_rd_0_m_axis_video_TLAST),
        .s_axis_video1_TREADY(v_frmbuf_rd_0_m_axis_video_TREADY),
        .s_axis_video1_TSTRB(v_frmbuf_rd_0_m_axis_video_TSTRB),
        .s_axis_video1_TUSER(v_frmbuf_rd_0_m_axis_video_TUSER),
        .s_axis_video1_TVALID(v_frmbuf_rd_0_m_axis_video_TVALID),
