...
(* CORE_GENERATION_INFO = "top_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=top_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=21,numReposBlks=21,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=16,da_board_cnt=5,da_clkrst_cnt=2,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "top_design.hwdef" *) 
module top_design
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]v_frmbuf_rd_1_m_axi_mm_video_ARADDR;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_ARBURST;
  wire [3:0]v_frmbuf_rd_1_m_axi_mm_video_ARCACHE;
  wire [7:0]v_frmbuf_rd_1_m_axi_mm_video_ARLEN;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_ARLOCK;
  wire [2:0]v_frmbuf_rd_1_m_axi_mm_video_ARPROT;
  wire [3:0]v_frmbuf_rd_1_m_axi_mm_video_ARQOS;
  wire v_frmbuf_rd_1_m_axi_mm_video_ARREADY;
  wire [2:0]v_frmbuf_rd_1_m_axi_mm_video_ARSIZE;
  wire v_frmbuf_rd_1_m_axi_mm_video_ARVALID;
  wire [31:0]v_frmbuf_rd_1_m_axi_mm_video_AWADDR;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_AWBURST;
  wire [3:0]v_frmbuf_rd_1_m_axi_mm_video_AWCACHE;
  wire [7:0]v_frmbuf_rd_1_m_axi_mm_video_AWLEN;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_AWLOCK;
  wire [2:0]v_frmbuf_rd_1_m_axi_mm_video_AWPROT;
  wire [3:0]v_frmbuf_rd_1_m_axi_mm_video_AWQOS;
  wire v_frmbuf_rd_1_m_axi_mm_video_AWREADY;
  wire [2:0]v_frmbuf_rd_1_m_axi_mm_video_AWSIZE;
  wire v_frmbuf_rd_1_m_axi_mm_video_AWVALID;
  wire v_frmbuf_rd_1_m_axi_mm_video_BREADY;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_BRESP;
  wire v_frmbuf_rd_1_m_axi_mm_video_BVALID;
  wire [63:0]v_frmbuf_rd_1_m_axi_mm_video_RDATA;
  wire v_frmbuf_rd_1_m_axi_mm_video_RLAST;
  wire v_frmbuf_rd_1_m_axi_mm_video_RREADY;
  wire [1:0]v_frmbuf_rd_1_m_axi_mm_video_RRESP;
  wire v_frmbuf_rd_1_m_axi_mm_video_RVALID;
  wire [63:0]v_frmbuf_rd_1_m_axi_mm_video_WDATA;
  wire v_frmbuf_rd_1_m_axi_mm_video_WLAST;
  wire v_frmbuf_rd_1_m_axi_mm_video_WREADY;
  wire [7:0]v_frmbuf_rd_1_m_axi_mm_video_WSTRB;
  wire v_frmbuf_rd_1_m_axi_mm_video_WVALID;
  wire [23:0]v_frmbuf_rd_1_m_axis_video_TDATA;
  wire [0:0]v_frmbuf_rd_1_m_axis_video_TDEST;
  wire [0:0]v_frmbuf_rd_1_m_axis_video_TID;
  wire [2:0]v_frmbuf_rd_1_m_axis_video_TKEEP;
  wire [0:0]v_frmbuf_rd_1_m_axis_video_TLAST;
  wire v_frmbuf_rd_1_m_axis_video_TREADY;
  wire [2:0]v_frmbuf_rd_1_m_axis_video_TSTRB;
  wire [0:0]v_frmbuf_rd_1_m_axis_video_TUSER;
  wire v_frmbuf_rd_1_m_axis_video_TVALID;
  ...
  assign ilconcat_0_dout = {v_frmbuf_rd_1_interrupt, v_mix_0_interrupt, v_tpg_0_interrupt, v_frmbuf_wr_0_interrupt, v_frmbuf_rd_0_interrupt, v_tc_0_irq};
  assign HDMI_EN = 1'h1;
  ...
  assign ilslice_4_Dout = processing_system7_0_GPIO_O[4:4];
  ...
  top_design_rst_ps7_0_148M_2 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  top_design_rst_ps7_0_148M_1 rst_ps7_0_150M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
  ...
  top_design_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S02_AXI_araddr(v_frmbuf_rd_1_m_axi_mm_video_ARADDR),
        .S02_AXI_arburst(v_frmbuf_rd_1_m_axi_mm_video_ARBURST),
        .S02_AXI_arcache(v_frmbuf_rd_1_m_axi_mm_video_ARCACHE),
        .S02_AXI_arlen(v_frmbuf_rd_1_m_axi_mm_video_ARLEN),
        .S02_AXI_arlock(v_frmbuf_rd_1_m_axi_mm_video_ARLOCK[0]),
        .S02_AXI_arprot(v_frmbuf_rd_1_m_axi_mm_video_ARPROT),
        .S02_AXI_arqos(v_frmbuf_rd_1_m_axi_mm_video_ARQOS),
        .S02_AXI_arready(v_frmbuf_rd_1_m_axi_mm_video_ARREADY),
        .S02_AXI_arsize(v_frmbuf_rd_1_m_axi_mm_video_ARSIZE),
        .S02_AXI_arvalid(v_frmbuf_rd_1_m_axi_mm_video_ARVALID),
        .S02_AXI_awaddr(v_frmbuf_rd_1_m_axi_mm_video_AWADDR),
        .S02_AXI_awburst(v_frmbuf_rd_1_m_axi_mm_video_AWBURST),
        .S02_AXI_awcache(v_frmbuf_rd_1_m_axi_mm_video_AWCACHE),
        .S02_AXI_awlen(v_frmbuf_rd_1_m_axi_mm_video_AWLEN),
        .S02_AXI_awlock(v_frmbuf_rd_1_m_axi_mm_video_AWLOCK[0]),
        .S02_AXI_awprot(v_frmbuf_rd_1_m_axi_mm_video_AWPROT),
        .S02_AXI_awqos(v_frmbuf_rd_1_m_axi_mm_video_AWQOS),
        .S02_AXI_awready(v_frmbuf_rd_1_m_axi_mm_video_AWREADY),
        .S02_AXI_awsize(v_frmbuf_rd_1_m_axi_mm_video_AWSIZE),
        .S02_AXI_awvalid(v_frmbuf_rd_1_m_axi_mm_video_AWVALID),
        .S02_AXI_bready(v_frmbuf_rd_1_m_axi_mm_video_BREADY),
        .S02_AXI_bresp(v_frmbuf_rd_1_m_axi_mm_video_BRESP),
        .S02_AXI_bvalid(v_frmbuf_rd_1_m_axi_mm_video_BVALID),
        .S02_AXI_rdata(v_frmbuf_rd_1_m_axi_mm_video_RDATA),
        .S02_AXI_rlast(v_frmbuf_rd_1_m_axi_mm_video_RLAST),
        .S02_AXI_rready(v_frmbuf_rd_1_m_axi_mm_video_RREADY),
        .S02_AXI_rresp(v_frmbuf_rd_1_m_axi_mm_video_RRESP),
        .S02_AXI_rvalid(v_frmbuf_rd_1_m_axi_mm_video_RVALID),
        .S02_AXI_wdata(v_frmbuf_rd_1_m_axi_mm_video_WDATA),
        .S02_AXI_wlast(v_frmbuf_rd_1_m_axi_mm_video_WLAST),
        .S02_AXI_wready(v_frmbuf_rd_1_m_axi_mm_video_WREADY),
        .S02_AXI_wstrb(v_frmbuf_rd_1_m_axi_mm_video_WSTRB),
        .S02_AXI_wvalid(v_frmbuf_rd_1_m_axi_mm_video_WVALID),
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_148M_peripheral_aresetn));
  ...
  top_design_v_frmbuf_rd_0_1 v_frmbuf_rd_1
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(ilslice_4_Dout),
        .interrupt(v_frmbuf_rd_1_interrupt),
        .m_axi_mm_video_ARADDR(v_frmbuf_rd_1_m_axi_mm_video_ARADDR),
        .m_axi_mm_video_ARBURST(v_frmbuf_rd_1_m_axi_mm_video_ARBURST),
        .m_axi_mm_video_ARCACHE(v_frmbuf_rd_1_m_axi_mm_video_ARCACHE),
        .m_axi_mm_video_ARLEN(v_frmbuf_rd_1_m_axi_mm_video_ARLEN),
        .m_axi_mm_video_ARLOCK(v_frmbuf_rd_1_m_axi_mm_video_ARLOCK),
        .m_axi_mm_video_ARPROT(v_frmbuf_rd_1_m_axi_mm_video_ARPROT),
        .m_axi_mm_video_ARQOS(v_frmbuf_rd_1_m_axi_mm_video_ARQOS),
        .m_axi_mm_video_ARREADY(v_frmbuf_rd_1_m_axi_mm_video_ARREADY),
        .m_axi_mm_video_ARSIZE(v_frmbuf_rd_1_m_axi_mm_video_ARSIZE),
        .m_axi_mm_video_ARVALID(v_frmbuf_rd_1_m_axi_mm_video_ARVALID),
        .m_axi_mm_video_AWADDR(v_frmbuf_rd_1_m_axi_mm_video_AWADDR),
        .m_axi_mm_video_AWBURST(v_frmbuf_rd_1_m_axi_mm_video_AWBURST),
        .m_axi_mm_video_AWCACHE(v_frmbuf_rd_1_m_axi_mm_video_AWCACHE),
        .m_axi_mm_video_AWLEN(v_frmbuf_rd_1_m_axi_mm_video_AWLEN),
        .m_axi_mm_video_AWLOCK(v_frmbuf_rd_1_m_axi_mm_video_AWLOCK),
        .m_axi_mm_video_AWPROT(v_frmbuf_rd_1_m_axi_mm_video_AWPROT),
        .m_axi_mm_video_AWQOS(v_frmbuf_rd_1_m_axi_mm_video_AWQOS),
        .m_axi_mm_video_AWREADY(v_frmbuf_rd_1_m_axi_mm_video_AWREADY),
        .m_axi_mm_video_AWSIZE(v_frmbuf_rd_1_m_axi_mm_video_AWSIZE),
        .m_axi_mm_video_AWVALID(v_frmbuf_rd_1_m_axi_mm_video_AWVALID),
        .m_axi_mm_video_BREADY(v_frmbuf_rd_1_m_axi_mm_video_BREADY),
        .m_axi_mm_video_BRESP(v_frmbuf_rd_1_m_axi_mm_video_BRESP),
        .m_axi_mm_video_BVALID(v_frmbuf_rd_1_m_axi_mm_video_BVALID),
        .m_axi_mm_video_RDATA(v_frmbuf_rd_1_m_axi_mm_video_RDATA),
        .m_axi_mm_video_RLAST(v_frmbuf_rd_1_m_axi_mm_video_RLAST),
        .m_axi_mm_video_RREADY(v_frmbuf_rd_1_m_axi_mm_video_RREADY),
        .m_axi_mm_video_RRESP(v_frmbuf_rd_1_m_axi_mm_video_RRESP),
        .m_axi_mm_video_RVALID(v_frmbuf_rd_1_m_axi_mm_video_RVALID),
        .m_axi_mm_video_WDATA(v_frmbuf_rd_1_m_axi_mm_video_WDATA),
        .m_axi_mm_video_WLAST(v_frmbuf_rd_1_m_axi_mm_video_WLAST),
        .m_axi_mm_video_WREADY(v_frmbuf_rd_1_m_axi_mm_video_WREADY),
        .m_axi_mm_video_WSTRB(v_frmbuf_rd_1_m_axi_mm_video_WSTRB),
