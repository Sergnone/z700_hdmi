...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit #(3, 0, 1, 1) top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit #(3, 1, 2, 2) top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit #(3, 2, 1, 1) top_design_v_frmbuf_rd_0_1_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
...
`include "top_design_v_frmbuf_rd_0_1_hls_deadlock_report_unit.vh"
