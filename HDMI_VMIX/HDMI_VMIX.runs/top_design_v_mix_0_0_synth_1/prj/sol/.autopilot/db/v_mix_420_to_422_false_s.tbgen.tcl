...
set Spec2ImplPortList { 
	srcLayer1 { ap_fifo {  { srcLayer1_dout fifo_data_out 0 24 }  { srcLayer1_empty_n fifo_status_empty 0 1 }  { srcLayer1_read fifo_data_in 1 1 }  { srcLayer1_num_data_valid fifo_update 0 3 }  { srcLayer1_fifo_cap fifo_data 0 3 } } }
	...
	srcLayer1Yuv422 { ap_fifo {  { srcLayer1Yuv422_din fifo_data_out 1 24 }  { srcLayer1Yuv422_full_n fifo_status_empty 0 1 }  { srcLayer1Yuv422_write fifo_data_in 1 1 }  { srcLayer1Yuv422_num_data_valid fifo_update 0 32 }  { srcLayer1Yuv422_fifo_cap fifo_data 0 32 } } }
}
