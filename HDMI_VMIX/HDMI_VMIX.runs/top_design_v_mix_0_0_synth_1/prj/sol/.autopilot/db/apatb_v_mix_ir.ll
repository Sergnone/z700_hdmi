...
define void @"arraycpy_hls.p0a4096struct.ap_uint<64>"([4096 x %"struct.ap_uint<64>"]* %dst, [4096 x %"struct.ap_uint<64>"]* readonly %src, i64 %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<64>"]* %src, null
  %1 = icmp eq [4096 x %"struct.ap_uint<64>"]* %dst, null
  %2 = or i1 %1, %0
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [4096 x %"struct.ap_uint<64>"], [4096 x %"struct.ap_uint<64>"]* %src, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [4096 x %"struct.ap_uint<64>"], [4096 x %"struct.ap_uint<64>"]* %dst, i64 0, i64 %for.loop.idx8, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<64>.78"([4096 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [4096 x i64]* nocapture readonly "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4096struct.ap_uint<64>.81"([4096 x %"struct.ap_uint<64>"]* nonnull %dst, [4096 x i64]* %src, i64 4096)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a4096struct.ap_uint<64>.81"([4096 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [4096 x i64]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a4096struct.ap_uint<64>.88"([4096 x i64]* %dst, [4096 x %"struct.ap_uint<64>"]* nonnull %src, i64 4096)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a4096struct.ap_uint<64>.88"([4096 x i64]* nocapture "unpacked"="0.0" %dst, [4096 x %"struct.ap_uint<64>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #1 {
entry:
  %0 = icmp eq [4096 x %"struct.ap_uint<64>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2i16.113.114(i16* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i16* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [2 x i16]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [2 x i16]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i16* align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [2 x i16]* readonly "orig.arg.no"="1" %src) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a2i16.113.114(i16* nonnull %dst_0, i16* %dst_1, [2 x i16]* nonnull %src, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2i8.117.118(i8* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i8* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [2 x i8]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq [2 x i8]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a2i8.116.119(i8* align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i8* align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, [2 x i8]* readonly "orig.arg.no"="1" %src) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a2i8.117.118(i8* nonnull %dst_0, i8* %dst_1, [2 x i8]* nonnull %src, i64 2)
  br label %ret
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.172"(i24* align 512 %_V_data_V, i3* align 512 %_V_keep_V, i3* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %0)
  ...
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_0, i16* align 512 %_1, [2 x i16]* %7)
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_01, i16* align 512 %_12, [2 x i16]* %8)
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_03, i16* align 512 %_14, [2 x i16]* %9)
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_05, i16* align 512 %_16, [2 x i16]* %10)
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_07, i16* align 512 %_18, [2 x i16]* %11)
  call void @onebyonecpy_hls.p0a2i8.116.119(i8* align 512 %_09, i8* align 512 %_110, [2 x i8]* %12)
  call fastcc void @onebyonecpy_hls.p0a2i8([2 x i8]* align 512 %14, [2 x i8]* %13)
  call void @onebyonecpy_hls.p0a2i16.112.115(i16* align 512 %_011, i16* align 512 %_112, [2 x i16]* %15)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.172"(i24* align 512 %_V_data_V1, i3* align 512 %_V_keep_V2, i3* align 512 %_V_strb_V3, i1* align 512 %_V_user_V4, i1* align 512 %_V_last_V5, i1* align 512 %_V_id_V6, i1* align 512 %_V_dest_V7, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %16)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2i16.125.126([2 x i16]* "orig.arg.no"="0" %dst, i16* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i16* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i64 "orig.arg.no"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* "orig.arg.no"="0" %dst, i16* readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i16* readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1) #2 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a2i16.125.126([2 x i16]* nonnull %dst, i16* nonnull %src_0, i16* %src_1, i64 2)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a2i8.129.130([2 x i8]* "orig.arg.no"="0" %dst, i8* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i8* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i64 "orig.arg.no"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a2i8.128.131([2 x i8]* "orig.arg.no"="0" %dst, i8* readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i8* readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1) #2 {
entry:
  %0 = icmp eq [2 x i8]* %dst, null
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a2i8.129.130([2 x i8]* nonnull %dst, i8* nonnull %src_0, i8* %src_1, i64 2)
  br label %ret
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<64>.78"([4096 x %"struct.ap_uint<64>"]* %1, [4096 x i64]* %2)
  call fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<64>.78"([4096 x %"struct.ap_uint<64>"]* %3, [4096 x i64]* %4)
  call fastcc void @"onebyonecpy_hls.p0a4096struct.ap_uint<64>.78"([4096 x %"struct.ap_uint<64>"]* %5, [4096 x i64]* %6)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %7, i16* align 512 %_0, i16* align 512 %_1)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %8, i16* align 512 %_01, i16* align 512 %_12)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %9, i16* align 512 %_03, i16* align 512 %_14)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %10, i16* align 512 %_05, i16* align 512 %_16)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %11, i16* align 512 %_07, i16* align 512 %_18)
  call void @onebyonecpy_hls.p0a2i8.128.131([2 x i8]* %12, i8* align 512 %_09, i8* align 512 %_110)
  call fastcc void @onebyonecpy_hls.p0a2i8([2 x i8]* %13, [2 x i8]* align 512 %14)
  call void @onebyonecpy_hls.p0a2i16.124.127([2 x i16]* %15, i16* align 512 %_011, i16* align 512 %_112)
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.165"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %dst, i24* align 512 %src_V_data_V, i3* align 512 %src_V_keep_V, i3* align 512 %src_V_strb_V, i1* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i1* align 512 %src_V_id_V, i1* align 512 %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.172"(i24* align 512 "unpacked"="0.0" %dst_V_data_V, i3* align 512 "unpacked"="0.1" %dst_V_keep_V, i3* align 512 "unpacked"="0.2" %dst_V_strb_V, i1* align 512 "unpacked"="0.3" %dst_V_user_V, i1* align 512 "unpacked"="0.4" %dst_V_last_V, i1* align 512 "unpacked"="0.5" %dst_V_id_V, i1* align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src) unnamed_addr #5 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.175"(i24* align 512 %dst_V_data_V, i3* align 512 %dst_V_keep_V, i3* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
