...
entity top_design_v_mix_0_0_CTRL_s_axi is
generic (
...
end entity top_design_v_mix_0_0_CTRL_s_axi;
...
architecture behave of top_design_v_mix_0_0_CTRL_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_LAYER1_BUF1_DATA_0        : INTEGER := 16#240#;
    constant ADDR_LAYER1_BUF1_CTRL          : INTEGER := 16#244#;
    constant ADDR_LAYER1_BUF2_DATA_0        : INTEGER := 16#24c#;
    constant ADDR_LAYER1_BUF2_CTRL          : INTEGER := 16#250#;
    constant ADDR_LAYER1_BUF3_DATA_0        : INTEGER := 16#258#;
    constant ADDR_LAYER1_BUF3_CTRL          : INTEGER := 16#25c#;
    ...
    signal int_layer1_buf1     : UNSIGNED(31 downto 0) := (others => '0');
    signal int_layer1_buf2     : UNSIGNED(31 downto 0) := (others => '0');
    signal int_layer1_buf3     : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_LAYER1_BUF1_DATA_0 =>
                        rdata_data <= RESIZE(int_layer1_buf1(31 downto 0), 32);
                    when ADDR_LAYER1_BUF2_DATA_0 =>
                        rdata_data <= RESIZE(int_layer1_buf2(31 downto 0), 32);
                    when ADDR_LAYER1_BUF3_DATA_0 =>
                        rdata_data <= RESIZE(int_layer1_buf3(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    layer1_buf1          <= STD_LOGIC_VECTOR(int_layer1_buf1);
    layer1_buf2          <= STD_LOGIC_VECTOR(int_layer1_buf2);
    layer1_buf3          <= STD_LOGIC_VECTOR(int_layer1_buf3);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layer1_buf1(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_BUF1_DATA_0) then
                    int_layer1_buf1(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_layer1_buf1(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layer1_buf2(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_BUF2_DATA_0) then
                    int_layer1_buf2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_layer1_buf2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_layer1_buf3(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_LAYER1_BUF3_DATA_0) then
                    int_layer1_buf3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_layer1_buf3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
