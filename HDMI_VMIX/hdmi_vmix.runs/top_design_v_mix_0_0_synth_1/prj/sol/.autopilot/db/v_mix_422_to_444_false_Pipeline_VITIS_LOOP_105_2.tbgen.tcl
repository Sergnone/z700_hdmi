...
set portList { 
	...
	{ srcLayer1Yuv422_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ srcLayer1Yuv422_fifo_cap sc_in sc_lv 3 signal 1 } 
	...
	{ srcLayer1Yuv_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ srcLayer1Yuv_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	srcLayer1Yuv422 { ap_fifo {  { srcLayer1Yuv422_dout fifo_data_out 0 24 }  { srcLayer1Yuv422_empty_n fifo_status_empty 0 1 }  { srcLayer1Yuv422_read fifo_data_in 1 1 }  { srcLayer1Yuv422_num_data_valid fifo_update 0 3 }  { srcLayer1Yuv422_fifo_cap fifo_data 0 3 } } }
	srcLayer1Yuv { ap_fifo {  { srcLayer1Yuv_din fifo_data_out 1 24 }  { srcLayer1Yuv_full_n fifo_status_empty 0 1 }  { srcLayer1Yuv_write fifo_data_in 1 1 }  { srcLayer1Yuv_num_data_valid fifo_update 0 32 }  { srcLayer1Yuv_fifo_cap fifo_data 0 32 } } }
}
