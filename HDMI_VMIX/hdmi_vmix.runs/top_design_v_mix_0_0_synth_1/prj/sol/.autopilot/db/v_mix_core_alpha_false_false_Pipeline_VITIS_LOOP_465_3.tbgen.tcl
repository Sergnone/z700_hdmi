...
set C_modelArgList {
	...
	{ add_ln478 int 17 regular {ap_stable 0} }
	{ icmp_ln476_1 int 1 regular  }
	{ rev5 int 1 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "hwReg_width_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln478", "interface" : "wire", "bitwidth" : 17, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln476_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ hwReg_background_Y_R_val sc_in sc_lv 8 signal 3 } 
	{ hwReg_background_U_G_val sc_in sc_lv 8 signal 4 } 
	{ hwReg_background_V_B_val sc_in sc_lv 8 signal 5 } 
	{ hwReg_layerStartX_1_val sc_in sc_lv 16 signal 6 } 
	{ add_ln478 sc_in sc_lv 17 signal 7 } 
	{ icmp_ln476_1 sc_in sc_lv 1 signal 8 } 
	{ rev5 sc_in sc_lv 1 signal 9 } 
	{ empty_50 sc_in sc_lv 1 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln478", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "add_ln478", "role": "default" }} , 
 	{ "name": "icmp_ln476_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln476_1", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	add_ln478 { ap_stable {  { add_ln478 in_data 0 17 } } }
	icmp_ln476_1 { ap_none {  { icmp_ln476_1 in_data 0 1 } } }
