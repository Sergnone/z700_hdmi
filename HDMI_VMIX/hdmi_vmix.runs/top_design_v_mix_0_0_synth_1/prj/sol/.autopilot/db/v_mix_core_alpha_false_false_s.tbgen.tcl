...
set portList { 
	...
	{ hwReg_layerStartY_1_val sc_in sc_lv 16 signal 9 } 
	{ hwReg_layerWidth_1_val sc_in sc_lv 16 signal 10 } 
	{ hwReg_layerHeight_1_val sc_in sc_lv 16 signal 11 } 
	{ hwReg_layerScaleFactor_1_val sc_in sc_lv 8 signal 12 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4481", "Max" : "2080081"}
	, {"Name" : "Interval", "Min" : "4481", "Max" : "2080081"}
]}
