...
set Spec2ImplPortList { 
	outYuv { ap_fifo {  { outYuv_dout fifo_data_out 0 24 }  { outYuv_empty_n fifo_status_empty 0 1 }  { outYuv_read fifo_data_in 1 1 }  { outYuv_num_data_valid fifo_update 0 3 }  { outYuv_fifo_cap fifo_data 0 3 } } }
	height_val { ap_stable {  { height_val in_data 0 11 } } }
	width_val { ap_stable {  { width_val in_data 0 11 } } }
	out422 { ap_fifo {  { out422_din fifo_data_out 1 24 }  { out422_full_n fifo_status_empty 0 1 }  { out422_write fifo_data_in 1 1 }  { out422_num_data_valid fifo_update 0 32 }  { out422_fifo_cap fifo_data 0 32 } } }
}
