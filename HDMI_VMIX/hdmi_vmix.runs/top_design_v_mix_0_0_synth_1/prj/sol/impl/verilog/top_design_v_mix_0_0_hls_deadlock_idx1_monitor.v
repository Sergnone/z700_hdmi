...
assign process_axis_block_vec[13] = idx10_block & (1'b0 | axis_block_sigs[6]);
...
// instant sub module
 ...
 top_design_v_mix_0_0_hls_deadlock_idx6_monitor top_design_v_mix_0_0_hls_deadlock_idx6_monitor_U (
    .clock(clock),
    .reset(reset),
    .axis_block_sigs(axis_block_sigs),
    .inst_idle_sigs(inst_idle_sigs),
