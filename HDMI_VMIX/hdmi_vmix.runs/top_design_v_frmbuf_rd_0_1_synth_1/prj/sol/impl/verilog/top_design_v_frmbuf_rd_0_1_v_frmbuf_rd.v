...
(* CORE_GENERATION_INFO="top_design_v_frmbuf_rd_0_1_v_frmbuf_rd,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.667000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.866910,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=2374,HLS_SYN_LUT=3248,HLS_VERSION=2025_2}" *)

(* DowngradeIPIdentifiedWarnings="yes" *)
module top_design_v_frmbuf_rd_0_1_v_frmbuf_rd (
        ap_clk,
        ap_rst_n,
...
top_design_v_frmbuf_rd_0_1_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
top_design_v_frmbuf_rd_0_1_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
top_design_v_frmbuf_rd_0_1_FrmbufRdHlsDataFlow grp_FrmbufRdHlsDataFlow_fu_166(
...
top_design_v_frmbuf_rd_0_1_CTRL_s_axi #(
...
top_design_v_frmbuf_rd_0_1_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 106 ),
...
top_design_v_frmbuf_rd_0_1_mul_14s_3ns_14_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 14 ),
    .din1_WIDTH( 3 ),
...
top_design_v_frmbuf_rd_0_1_regslice_both #(
    .DataWidth( 24 ))
...
`include "top_design_v_frmbuf_rd_0_1_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "top_design_v_frmbuf_rd_0_1_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //top_design_v_frmbuf_rd_0_1_v_frmbuf_rd
