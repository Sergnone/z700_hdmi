...
namespace eval ::optrace {
  variable script "/home/serg/Documents/Xilinx/z700_hdmi/HDMI_TEST_TPG/HDMI_TEST.runs/top_design_axi_gpio_0_0_synth_1/top_design_axi_gpio_0_0.tcl"
...
OPTRACE "top_design_axi_gpio_0_0_synth_1" START { ROLLUP_AUTO }
...
set cacheID [config_ip_cache -export -no_bom  -dir /home/serg/Documents/Xilinx/z700_hdmi/HDMI_TEST_TPG/HDMI_TEST.runs/top_design_axi_gpio_0_0_synth_1 -new_name top_design_axi_gpio_0_0 -ip [get_ips top_design_axi_gpio_0_0]]
...
synth_design -top top_design_axi_gpio_0_0 -part xc7z020clg400-2 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix top_design_axi_gpio_0_0_ top_design_axi_gpio_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_design_axi_gpio_0_0_stub.v
 lappend ipCachedFiles top_design_axi_gpio_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_design_axi_gpio_0_0_stub.vhdl
 lappend ipCachedFiles top_design_axi_gpio_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_design_axi_gpio_0_0_sim_netlist.v
 lappend ipCachedFiles top_design_axi_gpio_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ top_design_axi_gpio_0_0_sim_netlist.vhdl
 lappend ipCachedFiles top_design_axi_gpio_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp top_design_axi_gpio_0_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips top_design_axi_gpio_0_0]
 }
...
rename_ref -prefix_all top_design_axi_gpio_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef top_design_axi_gpio_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file top_design_axi_gpio_0_0_utilization_synth.rpt -pb top_design_axi_gpio_0_0_utilization_synth.pb"  } 
...
OPTRACE "top_design_axi_gpio_0_0_synth_1" END { }
