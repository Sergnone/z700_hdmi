...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_tpg_0_1_sparsemux_7_2_24_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { colorFormat_val17 { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ovrlayYUV_dout { I 24 vector } ovrlayYUV_empty_n { I 1 bit } ovrlayYUV_read { O 1 bit } ovrlayYUV_num_data_valid { I 5 vector } ovrlayYUV_fifo_cap { I 5 vector } } \
} "
}
