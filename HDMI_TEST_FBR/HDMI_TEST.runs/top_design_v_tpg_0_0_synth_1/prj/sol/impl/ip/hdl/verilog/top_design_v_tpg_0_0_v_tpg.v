...
(* CORE_GENERATION_INFO="top_design_v_tpg_0_0_v_tpg,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.750000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.890000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=6405,HLS_SYN_LUT=6587,HLS_VERSION=2025_2}" *)

(* DowngradeIPIdentifiedWarnings="yes" *)
module top_design_v_tpg_0_0_v_tpg (
        ap_clk,
        ap_rst_n,
        fid_in,
        m_axis_video_TDATA,
...
top_design_v_tpg_0_0_v_tpgHlsDataFlow grp_v_tpgHlsDataFlow_fu_440(
...
top_design_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_616(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
top_design_v_tpg_0_0_CTRL_s_axi #(
...
top_design_v_tpg_0_0_regslice_both #(
    .DataWidth( 24 ))
...
`include "top_design_v_tpg_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "top_design_v_tpg_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //top_design_v_tpg_0_0_v_tpg
