...
entity top_design_v_tpg_0_0_fifo_w24_d16_S is 
    generic (
...
architecture rtl of top_design_v_tpg_0_0_fifo_w24_d16_S is
...
------------------------Component----------------------
    component top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg : top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg
    generic map (
...
entity top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg;

architecture rtl of top_design_v_tpg_0_0_fifo_w24_d16_S_ShiftReg is
