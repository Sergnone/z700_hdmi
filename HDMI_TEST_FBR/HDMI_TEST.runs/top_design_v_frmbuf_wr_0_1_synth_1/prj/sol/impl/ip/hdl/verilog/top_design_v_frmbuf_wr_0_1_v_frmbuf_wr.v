...
module top_design_v_frmbuf_wr_0_1_v_frmbuf_wr (
        ap_clk,
        ap_rst_n,
...
reg  signed [13:0] trunc_ln157_reg_231;
wire   [5:0] trunc_ln157_1_fu_195_p1;
reg   [5:0] trunc_ln157_1_reg_236;
wire   [10:0] trunc_ln157_2_fu_199_p1;
reg   [10:0] trunc_ln157_2_reg_241;
wire   [10:0] trunc_ln157_3_fu_203_p1;
reg   [10:0] trunc_ln157_3_reg_246;
reg   [2:0] BYTES_PER_PIXEL_load_reg_261;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_266;
wire   [13:0] WidthInBytes_fu_216_p2;
reg   [13:0] WidthInBytes_reg_271;
...
wire   [13:0] WidthInBytes_fu_216_p10;
wire    ap_ce_reg;
...
top_design_v_frmbuf_wr_0_1_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
top_design_v_frmbuf_wr_0_1_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
top_design_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_164(
...
top_design_v_frmbuf_wr_0_1_CTRL_s_axi #(
...
top_design_v_frmbuf_wr_0_1_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 103 ),
...
top_design_v_frmbuf_wr_0_1_mul_14s_3ns_14_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 14 ),
    .din1_WIDTH( 3 ),
...
top_design_v_frmbuf_wr_0_1_regslice_both #(
    .DataWidth( 24 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state4) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state5)))) begin
...
assign WidthInBytes_fu_216_p10 = BYTES_PER_PIXEL_load_reg_261;
...
always @ (*) begin
    ap_block_state5_on_subcall_done = ((ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready & ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done) == 1'b0);
end
...
`include "top_design_v_frmbuf_wr_0_1_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "top_design_v_frmbuf_wr_0_1_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //top_design_v_frmbuf_wr_0_1_v_frmbuf_wr
