...
entity top_design_v_frmbuf_wr_0_0_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity top_design_v_frmbuf_wr_0_0_regslice_both;

architecture behave of top_design_v_frmbuf_wr_0_0_regslice_both is
