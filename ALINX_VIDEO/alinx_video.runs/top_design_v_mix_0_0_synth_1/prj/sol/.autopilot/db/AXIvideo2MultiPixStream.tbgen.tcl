...
set C_modelArgList {
	...
	{ WidthIn uint 11 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "s_axis_video_V_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "WidthIn", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Height sc_in sc_lv 11 signal 8 } 
	{ WidthIn sc_in sc_lv 11 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "WidthIn", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "WidthIn", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	WidthIn { ap_stable {  { WidthIn in_data 0 11 } } }
