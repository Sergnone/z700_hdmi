set moduleName v_mix_upsample_true_s
set isTopModule 0
...
set cdfgNum 39
set C_modelName {v_mix_upsample<true>}
...
set portList { 
	...
	{ srcLayer1x_din sc_out sc_lv 24 signal 5 } 
	{ srcLayer1x_full_n sc_in sc_logic 1 signal 5 } 
	{ srcLayer1x_write sc_out sc_logic 1 signal 5 } 
	{ srcLayer1x_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ srcLayer1x_fifo_cap sc_in sc_lv 3 signal 5 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "33203522"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "33203522"}
]}
