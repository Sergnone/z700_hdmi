...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module top_design_v_mix_0_0_CTRL_s_axi
#(parameter
    ...
    output wire [31:0]                   layer1_buf1,
    output wire [31:0]                   layer1_buf2,
    output wire [31:0]                   layer1_buf3,
...
localparam
    ...
    ADDR_LAYER1_BUF1_CTRL          = 12'h244,
    ADDR_LAYER1_BUF2_DATA_0        = 12'h24c,
    ADDR_LAYER1_BUF2_CTRL          = 12'h250,
    ADDR_LAYER1_BUF3_DATA_0        = 12'h258,
    ADDR_LAYER1_BUF3_CTRL          = 12'h25c,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_layer1_buf1 = 'b0;
    reg  [31:0]                   int_layer1_buf2 = 'b0;
    reg  [31:0]                   int_layer1_buf3 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_LAYER1_BUF3_DATA_0: begin
                    rdata <= int_layer1_buf3[31:0];
                end
...
assign layer1_buf3        = int_layer1_buf3;
...
// int_layer1_buf3[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_layer1_buf3[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_LAYER1_BUF3_DATA_0)
            int_layer1_buf3[31:0] <= (WDATA[31:0] & wmask) | (int_layer1_buf3[31:0] & ~wmask);
    end
end
