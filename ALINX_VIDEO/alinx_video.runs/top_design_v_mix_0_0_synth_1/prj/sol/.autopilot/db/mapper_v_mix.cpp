...
using hls::sim::Byte;
extern "C" void v_mix(Byte<8>*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, short, short, short, short, short, short, int, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, Byte<1>*, volatile void *, volatile void *, short, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_v_mix_hw(volatile void * __xlx_apatb_param_s_axis_video_V_data_V, volatile void * __xlx_apatb_param_s_axis_video_V_keep_V, volatile void * __xlx_apatb_param_s_axis_video_V_strb_V, volatile void * __xlx_apatb_param_s_axis_video_V_user_V, volatile void * __xlx_apatb_param_s_axis_video_V_last_V, volatile void * __xlx_apatb_param_s_axis_video_V_id_V, volatile void * __xlx_apatb_param_s_axis_video_V_dest_V, short __xlx_apatb_param_width, short __xlx_apatb_param_height, short __xlx_apatb_param_video_format, short __xlx_apatb_param_background_Y_R, short __xlx_apatb_param_background_U_G, short __xlx_apatb_param_background_V_B, int __xlx_apatb_param_layerEnable, volatile void * __xlx_apatb_param_layer1_buf1, volatile void * __xlx_apatb_param_layer1_buf2, volatile void * __xlx_apatb_param_layer1_buf3, volatile void * __xlx_apatb_param_layerAlpha_0, volatile void * __xlx_apatb_param_layerAlpha_1, volatile void * __xlx_apatb_param_layerStartX_0, volatile void * __xlx_apatb_param_layerStartX_1, volatile void * __xlx_apatb_param_layerStartY_0, volatile void * __xlx_apatb_param_layerStartY_1, volatile void * __xlx_apatb_param_layerWidth_0, volatile void * __xlx_apatb_param_layerWidth_1, volatile void * __xlx_apatb_param_layerHeight_0, volatile void * __xlx_apatb_param_layerHeight_1, volatile void * __xlx_apatb_param_layerScaleFactor_0, volatile void * __xlx_apatb_param_layerScaleFactor_1, volatile void * __xlx_apatb_param_layerVideoFormat, volatile void * __xlx_apatb_param_layerStride_0, volatile void * __xlx_apatb_param_layerStride_1, short __xlx_apatb_param_reserve, int __xlx_apatb_param_K11, int __xlx_apatb_param_K12, int __xlx_apatb_param_K13, int __xlx_apatb_param_K21, int __xlx_apatb_param_K22, int __xlx_apatb_param_K23, int __xlx_apatb_param_K31, int __xlx_apatb_param_K32, int __xlx_apatb_param_K33, int __xlx_apatb_param_ROffset, int __xlx_apatb_param_GOffset, int __xlx_apatb_param_BOffset, int __xlx_apatb_param_K11_2, int __xlx_apatb_param_K12_2, int __xlx_apatb_param_K13_2, int __xlx_apatb_param_K21_2, int __xlx_apatb_param_K22_2, int __xlx_apatb_param_K23_2, int __xlx_apatb_param_K31_2, int __xlx_apatb_param_K32_2, int __xlx_apatb_param_K33_2, int __xlx_apatb_param_YOffset, int __xlx_apatb_param_UOffset, int __xlx_apatb_param_VOffset, volatile void * __xlx_apatb_param_m_axis_video_V_data_V, volatile void * __xlx_apatb_param_m_axis_video_V_keep_V, volatile void * __xlx_apatb_param_m_axis_video_V_strb_V, volatile void * __xlx_apatb_param_m_axis_video_V_user_V, volatile void * __xlx_apatb_param_m_axis_video_V_last_V, volatile void * __xlx_apatb_param_m_axis_video_V_id_V, volatile void * __xlx_apatb_param_m_axis_video_V_dest_V) {
using hls::sim::createStream;
  // Collect __xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec
std::vector<Byte<8>> __xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec;
for (size_t i = 0; i < 4096; ++i){
__xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_layer1_buf1)[i]);
}
  int __xlx_size_param_layer1_buf1 = 4096;
  int __xlx_offset_param_layer1_buf1 = 0;
  int __xlx_offset_byte_param_layer1_buf1 = 0*8;
for (size_t i = 0; i < 4096; ++i){
__xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_layer1_buf2)[i]);
}
  int __xlx_size_param_layer1_buf2 = 4096;
  int __xlx_offset_param_layer1_buf2 = 4096;
  int __xlx_offset_byte_param_layer1_buf2 = 4096*8;
for (size_t i = 0; i < 4096; ++i){
__xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_layer1_buf3)[i]);
}
  int __xlx_size_param_layer1_buf3 = 4096;
  int __xlx_offset_param_layer1_buf3 = 8192;
  int __xlx_offset_byte_param_layer1_buf3 = 8192*8;
...
__xlx_layerVideoFormat__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_layerVideoFormat)[i]);
  ...
  int __xlx_size_param_layerVideoFormat = 2;
...
auto* sm_axis_video_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_m_axis_video_V_dest_V);
  // DUT call
  v_mix(__xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec.data(), ss_axis_video_V_data_V->data<int>(), ss_axis_video_V_keep_V->data<char>(), ss_axis_video_V_strb_V->data<char>(), ss_axis_video_V_user_V->data<char>(), ss_axis_video_V_last_V->data<char>(), ss_axis_video_V_id_V->data<char>(), ss_axis_video_V_dest_V->data<char>(), __xlx_apatb_param_width, __xlx_apatb_param_height, __xlx_apatb_param_video_format, __xlx_apatb_param_background_Y_R, __xlx_apatb_param_background_U_G, __xlx_apatb_param_background_V_B, __xlx_apatb_param_layerEnable, __xlx_offset_byte_param_layer1_buf1, __xlx_offset_byte_param_layer1_buf2, __xlx_offset_byte_param_layer1_buf3, __xlx_apatb_param_layerAlpha_0, __xlx_apatb_param_layerAlpha_1, __xlx_apatb_param_layerStartX_0, __xlx_apatb_param_layerStartX_1, __xlx_apatb_param_layerStartY_0, __xlx_apatb_param_layerStartY_1, __xlx_apatb_param_layerWidth_0, __xlx_apatb_param_layerWidth_1, __xlx_apatb_param_layerHeight_0, __xlx_apatb_param_layerHeight_1, __xlx_apatb_param_layerScaleFactor_0, __xlx_apatb_param_layerScaleFactor_1, __xlx_layerVideoFormat__tmp_vec.data(), __xlx_apatb_param_layerStride_0, __xlx_apatb_param_layerStride_1, __xlx_apatb_param_reserve, __xlx_apatb_param_K11, __xlx_apatb_param_K12, __xlx_apatb_param_K13, __xlx_apatb_param_K21, __xlx_apatb_param_K22, __xlx_apatb_param_K23, __xlx_apatb_param_K31, __xlx_apatb_param_K32, __xlx_apatb_param_K33, __xlx_apatb_param_ROffset, __xlx_apatb_param_GOffset, __xlx_apatb_param_BOffset, __xlx_apatb_param_K11_2, __xlx_apatb_param_K12_2, __xlx_apatb_param_K13_2, __xlx_apatb_param_K21_2, __xlx_apatb_param_K22_2, __xlx_apatb_param_K23_2, __xlx_apatb_param_K31_2, __xlx_apatb_param_K32_2, __xlx_apatb_param_K33_2, __xlx_apatb_param_YOffset, __xlx_apatb_param_UOffset, __xlx_apatb_param_VOffset, sm_axis_video_V_data_V->data<int>(), sm_axis_video_V_keep_V->data<char>(), sm_axis_video_V_strb_V->data<char>(), sm_axis_video_V_user_V->data<char>(), sm_axis_video_V_last_V->data<char>(), sm_axis_video_V_id_V->data<char>(), sm_axis_video_V_dest_V->data<char>());
// print __xlx_apatb_param_layer1_buf1
for (size_t i = 0; i < __xlx_size_param_layer1_buf1; ++i) {
((Byte<8>*)__xlx_apatb_param_layer1_buf1)[i] = __xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec[__xlx_offset_param_layer1_buf1+i];
}
// print __xlx_apatb_param_layer1_buf2
for (size_t i = 0; i < __xlx_size_param_layer1_buf2; ++i) {
((Byte<8>*)__xlx_apatb_param_layer1_buf2)[i] = __xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec[__xlx_offset_param_layer1_buf2+i];
}
// print __xlx_apatb_param_layer1_buf3
for (size_t i = 0; i < __xlx_size_param_layer1_buf3; ++i) {
((Byte<8>*)__xlx_apatb_param_layer1_buf3)[i] = __xlx_layer1_buf1_layer1_buf2_layer1_buf3__tmp_vec[__xlx_offset_param_layer1_buf3+i];
}
