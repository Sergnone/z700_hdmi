...
module top_design_v_mix_0_0_v_mix_yuv2rgb_false_Pipeline_VITIS_LOOP_897_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1_grp1 = ((srcLayer1Rgb_full_n == 1'b0) | (srcLayer1Yuv_empty_n == 1'b0));
end
...
assign icmp_ln897_fu_78_p2 = ((ap_sig_allocacmp_x_1 == empty) ? 1'b1 : 1'b0);

assign srcLayer1Rgb_din = srcLayer1Yuv_dout;

assign x_2_fu_84_p2 = (ap_sig_allocacmp_x_1 + 11'd1);

endmodule //top_design_v_mix_0_0_v_mix_yuv2rgb_false_Pipeline_VITIS_LOOP_897_2
