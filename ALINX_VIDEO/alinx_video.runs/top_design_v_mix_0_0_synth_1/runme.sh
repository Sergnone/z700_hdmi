...
HD_PWD='/home/serg/Documents/Xilinx/z700_hdmi/ALINX_VIDEO/alinx_video.runs/top_design_v_mix_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_v_mix_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_design_v_mix_0_0.tcl
