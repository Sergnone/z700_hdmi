...
module top_design_v_mix_0_0_hls_deadlock_idx1_monitor ( // for module top_design_v_mix_0_0_v_mix_inst.grp_VMixHlsDataFlowFunction_fu_431
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[14] = idx6_block & (1'b0 | axis_block_sigs[3]);
...
// instant sub module
 top_design_v_mix_0_0_hls_deadlock_idx2_monitor top_design_v_mix_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
