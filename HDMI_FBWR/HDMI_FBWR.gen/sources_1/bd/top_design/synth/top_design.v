...
module top_design
  ...
  assign ilconcat_0_dout = {v_frmbuf_wr_0_interrupt};
  assign HDMI_EN = 1'h1;
  ...
  top_design_system_ila_0_0 system_ila_0
       (.SLOT_0_AXIS_tdata({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        ...
        .SLOT_1_AXIS_tdata(v_tpg_0_m_axis_video1_TDATA),
        .SLOT_1_AXIS_tdest(v_tpg_0_m_axis_video1_TDEST),
        .SLOT_1_AXIS_tid(v_tpg_0_m_axis_video1_TID),
        .SLOT_1_AXIS_tkeep(v_tpg_0_m_axis_video1_TKEEP),
        .SLOT_1_AXIS_tlast(v_tpg_0_m_axis_video1_TLAST),
        .SLOT_1_AXIS_tready(v_tpg_0_m_axis_video1_TREADY),
        .SLOT_1_AXIS_tstrb(v_tpg_0_m_axis_video1_TSTRB),
        .SLOT_1_AXIS_tuser(v_tpg_0_m_axis_video1_TUSER),
        .SLOT_1_AXIS_tvalid(v_tpg_0_m_axis_video1_TVALID),
