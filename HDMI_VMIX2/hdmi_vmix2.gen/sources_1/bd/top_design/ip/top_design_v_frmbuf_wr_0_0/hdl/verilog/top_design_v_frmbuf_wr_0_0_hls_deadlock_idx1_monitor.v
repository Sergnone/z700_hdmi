...
module top_design_v_frmbuf_wr_0_0_hls_deadlock_idx1_monitor ( // for module top_design_v_frmbuf_wr_0_0_v_frmbuf_wr_inst.grp_FrmbufWrHlsDataFlow_fu_164
    input wire clock,
    input wire reset,
...
// instant sub module
 top_design_v_frmbuf_wr_0_0_hls_deadlock_idx2_monitor top_design_v_frmbuf_wr_0_0_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
