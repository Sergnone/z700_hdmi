set moduleName v_mix_upsample_alpha_true_Pipeline_VITIS_LOOP_236_2
set isTopModule 0
...
set cdfgNum 42
set C_modelName {v_mix_upsample_alpha<true>_Pipeline_VITIS_LOOP_236_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ shl_ln236_i int 18 regular {ap_stable 0} }
	{ srcLayer1Alphax int 8 regular {fifo 1 volatile }  }
	{ srcLayer1Alpha int 8 regular {fifo 0 volatile }  }
	{ zext_ln223_i int 2 regular {ap_stable 0} }
	{ add_ln234_i int 2 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "shl_ln236_i", "interface" : "wire", "bitwidth" : 18, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln223_i", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln234_i", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ srcLayer1Alpha_dout sc_in sc_lv 8 signal 2 } 
	{ srcLayer1Alpha_empty_n sc_in sc_logic 1 signal 2 } 
	{ srcLayer1Alpha_read sc_out sc_logic 1 signal 2 } 
	{ srcLayer1Alpha_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ srcLayer1Alpha_fifo_cap sc_in sc_lv 5 signal 2 } 
	{ srcLayer1Alphax_din sc_out sc_lv 8 signal 1 } 
	{ srcLayer1Alphax_full_n sc_in sc_logic 1 signal 1 } 
	{ srcLayer1Alphax_write sc_out sc_logic 1 signal 1 } 
	{ srcLayer1Alphax_num_data_valid sc_in sc_lv 5 signal 1 } 
	{ srcLayer1Alphax_fifo_cap sc_in sc_lv 5 signal 1 } 
	{ shl_ln236_i sc_in sc_lv 18 signal 0 } 
	{ zext_ln223_i sc_in sc_lv 2 signal 3 } 
	{ add_ln234_i sc_in sc_lv 2 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "shl_ln236_i", "direction": "in", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "shl_ln236_i", "role": "default" }} , 
 	{ "name": "zext_ln223_i", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "zext_ln223_i", "role": "default" }} , 
 	{ "name": "add_ln234_i", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "add_ln234_i", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "262144"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "262141"}
]}
...
set Spec2ImplPortList { 
	shl_ln236_i { ap_stable {  { shl_ln236_i in_data 0 18 } } }
	...
	zext_ln223_i { ap_stable {  { zext_ln223_i in_data 0 2 } } }
	add_ln234_i { ap_stable {  { add_ln234_i in_data 0 2 } } }
