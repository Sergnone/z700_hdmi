...
HD_PWD='/home/serg/Documents/Xilinx/z700_hdmi/HDMI_TEST_IMAGE/project_3.runs/top_design_v_tc_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_v_tc_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_design_v_tc_0_1.tcl
