...
reg   [31:0] frm_buffer_read_reg_222;
reg   [15:0] stride_read_reg_227;
wire  signed [13:0] trunc_ln157_fu_191_p1;
reg  signed [13:0] trunc_ln157_reg_232;
wire   [5:0] trunc_ln157_1_fu_195_p1;
reg   [5:0] trunc_ln157_1_reg_237;
wire   [10:0] trunc_ln157_2_fu_199_p1;
reg   [10:0] trunc_ln157_2_reg_242;
wire   [10:0] trunc_ln157_3_fu_203_p1;
reg   [10:0] trunc_ln157_3_reg_247;
wire   [13:0] WidthInBytes_fu_217_p2;
reg   [13:0] WidthInBytes_reg_262;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_267;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_AWUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WVALID;
wire   [63:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WDATA;
wire   [7:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WSTRB;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WLAST;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WID;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_WUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARVALID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARADDR;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARID;
wire   [31:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARLEN;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARSIZE;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARBURST;
wire   [1:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARLOCK;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARCACHE;
wire   [2:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARPROT;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARQOS;
wire   [3:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARREGION;
wire   [0:0] grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_ARUSER;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_RREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_164_m_axi_mm_video_0_BREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_164_s_axis_video_TREADY;
wire    grp_FrmbufWrHlsDataFlow_fu_164_ap_start;
wire    grp_FrmbufWrHlsDataFlow_fu_164_ap_done;
wire    grp_FrmbufWrHlsDataFlow_fu_164_ap_ready;
wire    grp_FrmbufWrHlsDataFlow_fu_164_ap_idle;
reg    grp_FrmbufWrHlsDataFlow_fu_164_ap_continue;
wire    flush;
...
reg    grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready;
reg    ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done;
reg    ap_block_state4_on_subcall_done;
wire    ap_sync_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready;
wire   [31:0] zext_ln253_fu_207_p1;
reg    BYTES_PER_PIXEL_ce0_local;
reg    MEMORY2LIVE_ce0_local;
wire   [2:0] WidthInBytes_fu_217_p1;
reg   [3:0] ap_NS_fsm;
...
wire   [13:0] WidthInBytes_fu_217_p10;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready = 1'b0;
#0 ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done = 1'b0;
end

top_design_v_frmbuf_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
BYTES_PER_PIXEL_U(
...
top_design_v_frmbuf_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R #(
    .DataWidth( 3 ),
    .AddressRange( 45 ),
    .AddressWidth( 6 ))
MEMORY2LIVE_U(
...
top_design_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_164(
...
top_design_v_frmbuf_wr_0_0_CTRL_s_axi #(
...
top_design_v_frmbuf_wr_0_0_mm_video_m_axi #(
    .CONSERVATIVE( 1 ),
    .USER_MAXREQS( 103 ),
...
top_design_v_frmbuf_wr_0_0_mul_14s_3ns_14_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 14 ),
    .din1_WIDTH( 3 ),
...
top_design_v_frmbuf_wr_0_0_regslice_both #(
    .DataWidth( 24 ))
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_164_ap_done == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready <= 1'b0;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_164_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg <= 1'b1;
        end else if ((grp_FrmbufWrHlsDataFlow_fu_164_ap_ready == 1'b1)) begin
            grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg <= 1'b0;
        end
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_FrmbufWrHlsDataFlow_fu_164_ap_continue = 1'b1;
    end else begin
        grp_FrmbufWrHlsDataFlow_fu_164_ap_continue = 1'b0;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln253_fu_207_p1;

assign MEMORY2LIVE_address0 = zext_ln253_fu_207_p1;

assign WidthInBytes_fu_217_p1 = WidthInBytes_fu_217_p10;

assign WidthInBytes_fu_217_p10 = BYTES_PER_PIXEL_q0;
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready & ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_done) == 1'b0);
end
...
assign ap_sync_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready = (grp_FrmbufWrHlsDataFlow_fu_164_ap_ready | ap_sync_reg_grp_FrmbufWrHlsDataFlow_fu_164_ap_ready);

assign grp_FrmbufWrHlsDataFlow_fu_164_ap_start = grp_FrmbufWrHlsDataFlow_fu_164_ap_start_reg;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign trunc_ln157_1_fu_195_p1 = video_format[5:0];

assign trunc_ln157_2_fu_199_p1 = width[10:0];

assign trunc_ln157_3_fu_203_p1 = height[10:0];

assign trunc_ln157_fu_191_p1 = width[13:0];

assign zext_ln253_fu_207_p1 = video_format;


reg find_df_deadlock = 0;
// synthesis translate_off
`include "top_design_v_frmbuf_wr_0_0_hls_deadlock_detector.vh"
// synthesis translate_on

reg find_kernel_block = 0;
// synthesis translate_off
`include "top_design_v_frmbuf_wr_0_0_hls_deadlock_kernel_monitor_top.vh"
// synthesis translate_on

endmodule //top_design_v_frmbuf_wr_0_0_v_frmbuf_wr
