...
entity top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S is 
    generic (
...
architecture rtl of top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S is
...
------------------------Component----------------------
    component top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg : top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg
    generic map (
...
entity top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 24;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg;

architecture rtl of top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S_ShiftReg is
