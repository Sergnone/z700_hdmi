...
// 
// ==============================================================
#ifndef XTOP_DESIGN_V_TPG_0_1_V_TPG_H
#define XTOP_DESIGN_V_TPG_0_1_V_TPG_H
...
#include <stddef.h>
#endif
#include "xtop_design_v_tpg_0_1_v_tpg_hw.h"
...
typedef struct {
    ...
    u16 DeviceId;
#endif
    u64 Top_design_v_tpg_0_1_ctrl_BaseAddress;
} XTop_design_v_tpg_0_1_v_tpg_Config;
#endif

typedef struct {
    u64 Top_design_v_tpg_0_1_ctrl_BaseAddress;
    u32 IsReady;
} XTop_design_v_tpg_0_1_v_tpg;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XTop_design_v_tpg_0_1_v_tpg_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XTop_design_v_tpg_0_1_v_tpg_ReadReg(BaseAddress, RegOffset) \
