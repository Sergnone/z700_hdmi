...
set name top_design_v_frmbuf_rd_0_0_urem_10ns_3ns_2_14_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {urem} IMPL {auto_seq} LATENCY 13 ALLOW_PRAGMA 1
}


set name top_design_v_frmbuf_rd_0_0_mul_10ns_12ns_21_1_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_val { I 13 vector } } \
} "
}
