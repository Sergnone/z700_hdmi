...
set C_modelArgList {
	{ lshr_ln int 10 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "lshr_ln", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ lshr_ln sc_in sc_lv 10 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lshr_ln", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "lshr_ln", "role": "default" }} , 
...
set Spec2ImplPortList { 
	lshr_ln { ap_stable {  { lshr_ln in_data 0 10 } } }
