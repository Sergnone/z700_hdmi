...
set C_modelArgList {
	...
	{ WidthOut_val int 11 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "img", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "WidthOut_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Height_val sc_in sc_lv 10 signal 8 } 
	{ WidthOut_val sc_in sc_lv 11 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "WidthOut_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "WidthOut_val", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "925929"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "925929"}
]}
...
set Spec2ImplPortList { 
	...
	WidthOut_val { ap_stable {  { WidthOut_val in_data 0 11 } } }
