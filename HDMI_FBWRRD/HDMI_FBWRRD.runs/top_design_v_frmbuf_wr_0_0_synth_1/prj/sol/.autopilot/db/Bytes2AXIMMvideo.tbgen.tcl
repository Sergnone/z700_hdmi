...
set C_modelArgList {
	...
	{ Height_val int 10 regular {ap_stable 0} }
	{ WidthInBytes_val int 13 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "bytePlanes", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "Height_val", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "WidthInBytes_val", "interface" : "wire", "bitwidth" : 13, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dstImg sc_in sc_lv 32 signal 2 } 
	{ Height_val sc_in sc_lv 10 signal 3 } 
	{ WidthInBytes_val sc_in sc_lv 13 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Height_val", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "Height_val", "role": "default" }} , 
 	{ "name": "WidthInBytes_val", "direction": "in", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "WidthInBytes_val", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7041", "Max" : "771121"}
	, {"Name" : "Interval", "Min" : "7041", "Max" : "771121"}
]}
...
set Spec2ImplPortList { 
	...
	Height_val { ap_stable {  { Height_val in_data 0 10 } } }
	WidthInBytes_val { ap_stable {  { WidthInBytes_val in_data 0 13 } } }
