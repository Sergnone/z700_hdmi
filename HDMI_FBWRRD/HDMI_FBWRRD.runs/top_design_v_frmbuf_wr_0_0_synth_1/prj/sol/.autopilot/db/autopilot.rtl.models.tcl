set SynModuleInfo {
  ...
  {SRCNAME MultiPixStream2Bytes MODELNAME MultiPixStream2Bytes RTLNAME top_design_v_frmbuf_wr_0_0_MultiPixStream2Bytes
    SUBMODULES {
      {MODELNAME top_design_v_frmbuf_wr_0_0_mul_10ns_12ns_21_1_1 RTLNAME top_design_v_frmbuf_wr_0_0_mul_10ns_12ns_21_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME FrmbufWrHlsDataFlow MODELNAME FrmbufWrHlsDataFlow RTLNAME top_design_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow
    SUBMODULES {
      ...
      {MODELNAME top_design_v_frmbuf_wr_0_0_fifo_w64_d321_B RTLNAME top_design_v_frmbuf_wr_0_0_fifo_w64_d321_B BINDTYPE storage TYPE fifo IMPL bram ALLOW_PRAGMA 1 INSTNAME bytePlanes_U}
  ...
  {SRCNAME v_frmbuf_wr MODELNAME v_frmbuf_wr RTLNAME top_design_v_frmbuf_wr_0_0_v_frmbuf_wr IS_TOP 1
    SUBMODULES {
      {MODELNAME top_design_v_frmbuf_wr_0_0_mul_13s_3ns_13_1_1 RTLNAME top_design_v_frmbuf_wr_0_0_mul_13s_3ns_13_1_1 BINDTYPE op TYPE mul IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
