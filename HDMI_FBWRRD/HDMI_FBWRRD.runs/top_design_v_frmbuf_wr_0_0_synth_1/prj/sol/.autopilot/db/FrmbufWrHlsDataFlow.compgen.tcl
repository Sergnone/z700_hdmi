...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_frmbuf_wr_0_0_fifo_w64_d321_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_val2 { I 13 vector } WidthInBytes_val2_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val8 { I 10 vector } height_val8_ap_vld { I 1 bit } } \
} "
}
