...
module top_design_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow (
        s_axis_video_TDATA,
        s_axis_video_TKEEP,
        s_axis_video_TSTRB,
        s_axis_video_TUSER,
...
input  [12:0] WidthInBytes_val2;
input  [2:0] colorFormat_val3;
input  [10:0] width_val5;
input  [9:0] height_val8;
...
top_design_v_frmbuf_wr_0_0_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
top_design_v_frmbuf_wr_0_0_MultiPixStream2Bytes MultiPixStream2Bytes_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
top_design_v_frmbuf_wr_0_0_fifo_w64_d321_B bytePlanes_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
top_design_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0 start_for_MultiPixStream2Bytes_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
top_design_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0 start_for_Bytes2AXIMMvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //top_design_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow
