...
HD_PWD='C:/Users/Sergey/Documents/Xilinx/z7000_hdmi/HDMI_FBWRRD/HDMI_FBWRRD.runs/top_design_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_design_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_design_axi_smc_0.tcl
