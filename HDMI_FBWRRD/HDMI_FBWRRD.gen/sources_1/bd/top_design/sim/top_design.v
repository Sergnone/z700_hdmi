...
module top_design
  ...
  wire [7:0]axi_smc_M02_AXI_ARADDR;
  wire axi_smc_M02_AXI_ARREADY;
  wire axi_smc_M02_AXI_ARVALID;
  wire [7:0]axi_smc_M02_AXI_AWADDR;
  ...
  top_design_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  top_design_rst_ps7_0_150M_0 rst_ps7_0_150M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
  ...
  top_design_v_frmbuf_wr_0_0 v_frmbuf_wr_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        ...
        .s_axis_video_TDATA(v_tpg_0_m_axis_video1_TDATA),
        .s_axis_video_TDEST(v_tpg_0_m_axis_video1_TDEST),
        .s_axis_video_TID(v_tpg_0_m_axis_video1_TID),
        .s_axis_video_TKEEP(v_tpg_0_m_axis_video1_TKEEP),
        .s_axis_video_TLAST(v_tpg_0_m_axis_video1_TLAST),
        .s_axis_video_TREADY(v_tpg_0_m_axis_video1_TREADY),
  ...
  top_design_v_tpg_0_0 v_tpg_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(ilslice_2_Dout),
        .fid_in(1'b1),
        .interrupt(v_tpg_0_interrupt),
        .m_axis_video_TDATA(v_tpg_0_m_axis_video1_TDATA),
        .m_axis_video_TDEST(v_tpg_0_m_axis_video1_TDEST),
        .m_axis_video_TID(v_tpg_0_m_axis_video1_TID),
        .m_axis_video_TKEEP(v_tpg_0_m_axis_video1_TKEEP),
        .m_axis_video_TLAST(v_tpg_0_m_axis_video1_TLAST),
        .m_axis_video_TREADY(v_tpg_0_m_axis_video1_TREADY),
        .m_axis_video_TSTRB(v_tpg_0_m_axis_video1_TSTRB),
        .m_axis_video_TUSER(v_tpg_0_m_axis_video1_TUSER),
        .m_axis_video_TVALID(v_tpg_0_m_axis_video1_TVALID),
