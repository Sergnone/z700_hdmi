...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L v_tc_v6_1_14 -L v_vid_in_axi4s_v4_0_11 -L v_axi4s_vid_out_v4_0_20 -L v_tc_v6_2_11 -L fifo_generator_v13_2_14 -L axi_datamover_v5_1_37 -L axi_vdma_v6_3_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top_design xil_defaultlib.top_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_design -key {Behavioral:sim_1:Functional:top_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b6ca.protoinst" -protoinst "protoinst_files/bd_8df6.protoinst" -protoinst "protoinst_files/top_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_design.wdb xsim.dir libdpi.so)
