...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_frmbuf_wr_0_0_fifo_w24_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {img_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_frmbuf_wr_0_0_fifo_w64_d481_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_frmbuf_wr_0_0_start_for_MultiPixStream2Bytes_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_MultiPixStream2Bytes_U0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_design_v_frmbuf_wr_0_0_start_for_Bytes2AXIMMvideo_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Bytes2AXIMMvideo_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { width_val4 { I 11 vector } width_val4_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_val7 { I 11 vector } height_val7_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 88 \
    name video_format_val9 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_video_format_val9 \
    op interface \
    ports { video_format_val9 { I 6 vector } video_format_val9_ap_vld { I 1 bit } } \
} "
}
