...
#ifndef XL_VTC_HW_H_
#define XL_VTC_HW_H_	/**< prevent circular inclusions
...
* @{
*/
#define XL_Vtc_In32			Xl_In32	/**< Input Operations */
#define XL_Vtc_Out32		Xl_Out32	/**< Output Operations */
...
*
******************************************************************************/
#define XL_Vtc_ReadReg(BaseAddress, RegOffset) \
		XL_Vtc_In32((BaseAddress) + ((uint32_t)RegOffset))
...
*
******************************************************************************/
#define XL_Vtc_WriteReg(BaseAddress, RegOffset, Data) 	\
		XL_Vtc_Out32((BaseAddress) + ((uint32_t)RegOffset), (uint32_t)(Data))
/*@}*/
