...
*
*****************************************************************************/
#define XL_GpioPs_ReadReg(BaseAddr, RegOffset)		\
		Xl_In32((BaseAddr) + (u32)(RegOffset))
...
*
*****************************************************************************/
#define XL_GpioPs_WriteReg(BaseAddr, RegOffset, Data)	\
		Xl_Out32((BaseAddr) + (u32)(RegOffset), (u32)(Data))
