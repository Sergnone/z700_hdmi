...
void XDesign_1_v_mix_0_0_v_mix_Set_layer1_buf1(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF1_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layer1_buf1(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF1_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layer1_buf2(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF2_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layer1_buf2(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF2_DATA);
    return Data;
}

void XDesign_1_v_mix_0_0_v_mix_Set_layer1_buf3(XDesign_1_v_mix_0_0_v_mix *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XDesign_1_v_mix_0_0_v_mix_WriteReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF3_DATA, Data);
}

u32 XDesign_1_v_mix_0_0_v_mix_Get_layer1_buf3(XDesign_1_v_mix_0_0_v_mix *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XDesign_1_v_mix_0_0_v_mix_ReadReg(InstancePtr->Design_1_v_mix_0_0_ctrl_BaseAddress, XDESIGN_1_V_MIX_0_0_V_MIX_DESIGN_1_V_MIX_0_0_CTRL_ADDR_LAYER1_BUF3_DATA);
    return Data;
}
