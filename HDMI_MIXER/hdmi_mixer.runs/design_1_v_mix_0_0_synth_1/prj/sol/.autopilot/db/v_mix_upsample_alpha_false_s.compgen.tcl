...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerHeight_1_val { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { HwReg_layerWidth_1_val { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { srcLayer1Alphax_din { O 8 vector } srcLayer1Alphax_full_n { I 1 bit } srcLayer1Alphax_write { O 1 bit } srcLayer1Alphax_num_data_valid { I 32 vector } srcLayer1Alphax_fifo_cap { I 32 vector } } \
} "
}
