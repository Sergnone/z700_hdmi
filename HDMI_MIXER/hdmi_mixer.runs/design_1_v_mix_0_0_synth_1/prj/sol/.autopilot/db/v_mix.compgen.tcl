...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_mix_0_0_bitselect_1ns_32ns_1ns_1_1_1 BINDTYPE {op} TYPE {bitselect} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler design_1_v_mix_0_0_mm_video1_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
