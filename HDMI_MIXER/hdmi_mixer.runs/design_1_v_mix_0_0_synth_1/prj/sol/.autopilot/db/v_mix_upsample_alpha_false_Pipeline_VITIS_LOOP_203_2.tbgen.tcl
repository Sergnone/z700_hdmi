set moduleName v_mix_upsample_alpha_false_Pipeline_VITIS_LOOP_203_2
set isTopModule 0
...
set cdfgNum 40
set C_modelName {v_mix_upsample_alpha<false>_Pipeline_VITIS_LOOP_203_2}
...
set portList { 
	...
	{ srcLayer1Alphax_num_data_valid sc_in sc_lv 32 signal 2 } 
	{ srcLayer1Alphax_fifo_cap sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcLayer1Alphax_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "srcLayer1Alphax", "role": "num_data_valid" }} , 
 	{ "name": "srcLayer1Alphax_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "srcLayer1Alphax", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	srcLayer1Alphax { ap_fifo {  { srcLayer1Alphax_din fifo_data_out 1 8 }  { srcLayer1Alphax_full_n fifo_status_empty 0 1 }  { srcLayer1Alphax_write fifo_data_in 1 1 }  { srcLayer1Alphax_num_data_valid fifo_update 0 32 }  { srcLayer1Alphax_fifo_cap fifo_data 0 32 } } }
}
