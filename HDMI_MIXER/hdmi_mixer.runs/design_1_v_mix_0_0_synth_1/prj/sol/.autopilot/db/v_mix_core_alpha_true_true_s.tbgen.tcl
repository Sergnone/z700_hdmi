...
set portList { 
	...
	{ hwReg_width_val sc_in sc_lv 11 signal 3 } 
	{ hwReg_height_val sc_in sc_lv 11 signal 4 } 
	...
	{ hwReg_layerEnable_val sc_in sc_lv 2 signal 8 } 
	{ hwReg_layerAlpha_1_val sc_in sc_lv 9 signal 9 } 
	{ hwReg_layerStartX_1_val sc_in sc_lv 16 signal 10 } 
	{ hwReg_layerStartY_1_val sc_in sc_lv 16 signal 11 } 
	{ hwReg_layerWidth_1_val sc_in sc_lv 16 signal 12 } 
	{ hwReg_layerHeight_1_val sc_in sc_lv 16 signal 13 } 
	{ hwReg_layerScaleFactor_1_val sc_in sc_lv 8 signal 14 } 
	...
	{ outLayer1_num_data_valid sc_in sc_lv 32 signal 15 } 
	{ outLayer1_fifo_cap sc_in sc_lv 32 signal 15 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4738", "Max" : "2084402"}
	, {"Name" : "Interval", "Min" : "4738", "Max" : "2084402"}
]}
