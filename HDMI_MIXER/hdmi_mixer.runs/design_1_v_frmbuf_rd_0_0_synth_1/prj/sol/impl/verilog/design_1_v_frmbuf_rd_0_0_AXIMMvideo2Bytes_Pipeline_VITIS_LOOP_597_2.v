...
module design_1_v_frmbuf_rd_0_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_597_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] x_fu_78;
wire   [10:0] add_ln597_fu_124_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_x_21;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln597_fu_118_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln597_fu_118_p2 == 1'd1))) begin
...
assign add_ln597_fu_124_p2 = (ap_sig_allocacmp_x_21 + 11'd1);
...
assign bytePlanes_plane1_din = mm_video_addr_read_reg_157;

assign icmp_ln597_fu_118_p2 = ((ap_sig_allocacmp_x_21 == loopwidth) ? 1'b1 : 1'b0);
...
endmodule //design_1_v_frmbuf_rd_0_0_AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_597_2
