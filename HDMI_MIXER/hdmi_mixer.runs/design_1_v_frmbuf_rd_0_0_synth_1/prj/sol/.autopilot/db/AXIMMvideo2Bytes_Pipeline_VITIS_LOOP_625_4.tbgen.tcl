set moduleName AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_625_4
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "loopwidth_1", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln625", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln625 sc_in sc_lv 29 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln625", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "sext_ln625", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln625 { ap_none {  { sext_ln625 in_data 0 29 } } }
