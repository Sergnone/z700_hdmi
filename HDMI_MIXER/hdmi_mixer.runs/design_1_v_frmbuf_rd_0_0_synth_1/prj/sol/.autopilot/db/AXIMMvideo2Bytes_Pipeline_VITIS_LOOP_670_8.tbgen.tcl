set moduleName AXIMMvideo2Bytes_Pipeline_VITIS_LOOP_670_8
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "lshr_ln", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln670", "interface" : "wire", "bitwidth" : 29, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln670 sc_in sc_lv 29 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln670", "direction": "in", "datatype": "sc_lv", "bitwidth":29, "type": "signal", "bundle":{"name": "sext_ln670", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln670 { ap_none {  { sext_ln670 in_data 0 29 } } }
