; ModuleID = '/home/serg/Documents/Xilinx/z700_hdmi/HDMI_MIXER/hdmi_mixer.runs/design_1_v_frmbuf_rd_0_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_v_frmbuf_rd_hw(i16 %width, i16 %height, i16 %stride, i16 %video_format, [2073600 x i64]* %frm_buffer_copy, [2073600 x i64]* %frm_buffer2_copy, [2073600 x i64]* %frm_buffer3_copy, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
...
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.67"(i24* align 512 %_V_data_V, i3* align 512 %_V_keep_V, i3* align 512 %_V_strb_V, i1* align 512 %_V_user_V, i1* align 512 %_V_last_V, i1* align 512 %_V_id_V, i1* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %6)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.34"([2073600 x %"struct.ap_uint<64>"]* %0, [2073600 x i64]* %1)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.34"([2073600 x %"struct.ap_uint<64>"]* %2, [2073600 x i64]* %3)
  call fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.34"([2073600 x %"struct.ap_uint<64>"]* %4, [2073600 x i64]* %5)
...
define internal fastcc void @"onebyonecpy_hls.p0a2073600struct.ap_uint<64>.34"([2073600 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [2073600 x i64]* nocapture readonly "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.37"([2073600 x %"struct.ap_uint<64>"]* nonnull %dst, [2073600 x i64]* %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.37"([2073600 x %"struct.ap_uint<64>"]* "unpacked"="0" %dst, [2073600 x i64]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.44"([2073600 x i64]* %dst, [2073600 x %"struct.ap_uint<64>"]* nonnull %src, i64 2073600)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a2073600struct.ap_uint<64>.44"([2073600 x i64]* nocapture "unpacked"="0.0" %dst, [2073600 x %"struct.ap_uint<64>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #6 {
entry:
  %0 = icmp eq [2073600 x %"struct.ap_uint<64>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.67"(i24* align 512 "unpacked"="0.0" %dst_V_data_V, i3* align 512 "unpacked"="0.1" %dst_V_keep_V, i3* align 512 "unpacked"="0.2" %dst_V_strb_V, i1* align 512 "unpacked"="0.3" %dst_V_user_V, i1* align 512 "unpacked"="0.4" %dst_V_last_V, i1* align 512 "unpacked"="0.5" %dst_V_id_V, i1* align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>.70"(i24* align 512 %dst_V_data_V, i3* align 512 %dst_V_keep_V, i3* align 512 %dst_V_strb_V, i1* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i1* align 512 %dst_V_id_V, i1* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* nonnull %src)
  br label %ret
...
declare void @apatb_v_frmbuf_rd_hw(i16, i16, i16, i16, [2073600 x i64]*, [2073600 x i64]*, [2073600 x i64]*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)
...
define void @v_frmbuf_rd_hw_stub_wrapper(i16, i16, i16, i16, [2073600 x i64]*, [2073600 x i64]*, [2073600 x i64]*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #7 {
entry:
  ...
  call void @v_frmbuf_rd_hw_stub(i16 %0, i16 %1, i16 %2, i16 %3, %"struct.ap_uint<64>"* %22, %"struct.ap_uint<64>"* %23, %"struct.ap_uint<64>"* %24, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1, '8', false>, 0>"* %21)
