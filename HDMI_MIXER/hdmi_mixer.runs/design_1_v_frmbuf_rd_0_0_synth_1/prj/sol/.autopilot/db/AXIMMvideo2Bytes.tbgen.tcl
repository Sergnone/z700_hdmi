...
set C_modelArgList {
	...
	{ srcImg3 int 32 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "mm_video", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "frm_buffer","offset": { "type": "dynamic","port_name": "frm_buffer","bundle": "CTRL"},"direction": "READONLY"},{"cName": "frm_buffer2","offset": { "type": "dynamic","port_name": "frm_buffer2","bundle": "CTRL"},"direction": "READONLY"},{"cName": "frm_buffer3","offset": { "type": "dynamic","port_name": "frm_buffer3","bundle": "CTRL"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "srcImg3", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ srcImg3 sc_in sc_lv 32 signal 3 } 
	{ bytePlanes_plane0_din sc_out sc_lv 64 signal 4 } 
	{ bytePlanes_plane0_full_n sc_in sc_logic 1 signal 4 } 
	{ bytePlanes_plane0_write sc_out sc_logic 1 signal 4 } 
	{ bytePlanes_plane0_num_data_valid sc_in sc_lv 10 signal 4 } 
	{ bytePlanes_plane0_fifo_cap sc_in sc_lv 10 signal 4 } 
	{ bytePlanes_plane1_din sc_out sc_lv 64 signal 5 } 
	{ bytePlanes_plane1_full_n sc_in sc_logic 1 signal 5 } 
	{ bytePlanes_plane1_write sc_out sc_logic 1 signal 5 } 
	{ bytePlanes_plane1_num_data_valid sc_in sc_lv 10 signal 5 } 
	{ bytePlanes_plane1_fifo_cap sc_in sc_lv 10 signal 5 } 
	{ bytePlanes_plane2_din sc_out sc_lv 64 signal 6 } 
	{ bytePlanes_plane2_full_n sc_in sc_logic 1 signal 6 } 
	{ bytePlanes_plane2_write sc_out sc_logic 1 signal 6 } 
	{ bytePlanes_plane2_num_data_valid sc_in sc_lv 10 signal 6 } 
	{ bytePlanes_plane2_fifo_cap sc_in sc_lv 10 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "srcImg3", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "srcImg3", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "193", "Max" : "5029561"}
	, {"Name" : "Interval", "Min" : "193", "Max" : "5029561"}
]}
...
set Spec2ImplPortList { 
	...
	srcImg3 { ap_stable {  { srcImg3 in_data 0 32 } } }
