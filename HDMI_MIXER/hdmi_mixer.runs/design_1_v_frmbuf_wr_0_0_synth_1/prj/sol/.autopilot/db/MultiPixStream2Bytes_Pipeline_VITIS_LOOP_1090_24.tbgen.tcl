set moduleName MultiPixStream2Bytes_Pipeline_VITIS_LOOP_1090_24
set isTopModule 0
...
set cdfgNum 29
set C_modelName {MultiPixStream2Bytes_Pipeline_VITIS_LOOP_1090_24}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ trunc_ln3 int 9 regular {ap_stable 0} }
...
set portList { 
	...
	{ trunc_ln3 sc_in sc_lv 9 signal 0 } 
...
set Spec2ImplPortList { 
	trunc_ln3 { ap_stable {  { trunc_ln3 in_data 0 9 } } }
	...
	icmp39 { ap_stable {  { icmp39 in_data 0 1 } } }
	...
	icmp36 { ap_stable {  { icmp36 in_data 0 1 } } }
}
