set moduleName MultiPixStream2Bytes_Pipeline_VITIS_LOOP_697_7
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "loopWidth_2", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln693", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "img", "interface" : "fifo", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "rev", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "out_pix_2_out", "interface" : "wire", "bitwidth" : 64, "direction" : "READWRITE"} ]}
...
set portList { 
	...
	{ sext_ln693 sc_in sc_lv 12 signal 2 } 
	{ rev sc_in sc_lv 1 signal 4 } 
	{ out_pix_2_out_i sc_in sc_lv 64 signal 5 } 
	{ out_pix_2_out_o sc_out sc_lv 64 signal 5 } 
	{ out_pix_2_out_o_ap_vld sc_out sc_logic 1 outvld 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln693", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sext_ln693", "role": "default" }} , 
 	{ "name": "rev", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "rev", "role": "default" }} , 
 	{ "name": "out_pix_2_out_i", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "out_pix_2_out", "role": "i" }} , 
 	{ "name": "out_pix_2_out_o", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "out_pix_2_out", "role": "o" }} , 
 	{ "name": "out_pix_2_out_o_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "out_pix_2_out", "role": "o_ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln693 { ap_stable {  { sext_ln693 in_data 0 12 } } }
	...
	out_pix_2_out { ap_ovld {  { out_pix_2_out_i in_data 0 64 }  { out_pix_2_out_o out_data 1 64 }  { out_pix_2_out_o_ap_vld out_vld 1 1 } } }
}
