...
architecture behav of design_1_v_tpg_0_0_v_tpg is 
    ...
    "design_1_v_tpg_0_0_v_tpg,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=6.522000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.652000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=9,HLS_SYN_DSP=0,HLS_SYN_FF=6648,HLS_SYN_LUT=6649,HLS_VERSION=2025_2}";
...
begin
    grp_v_tpgHlsDataFlow_fu_440 : component design_1_v_tpg_0_0_v_tpgHlsDataFlow
    port map (
    ...
    grp_reg_unsigned_short_s_fu_616 : component design_1_v_tpg_0_0_reg_unsigned_short_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
