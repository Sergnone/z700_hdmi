...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=20,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [0:0]rst_ps7_0_150M_peripheral_aresetn1;
  ...
  design_1_axi_dynclk_0_0 axi_dynclk_0
       (.LOCKED_O(axi_dynclk_0_LOCKED_O),
        ...
        .s_axi_lite_aresetn(rst_ps7_0_150M_peripheral_aresetn),
        .s_axi_lite_arprot(axi_smc_M00_AXI_ARPROT),
        ...
        .s_axi_lite_awprot(axi_smc_M00_AXI_AWPROT),
        ...
        .s_axi_lite_wstrb(axi_smc_M00_AXI_WSTRB),
  ...
  assign ilconcat_0_dout = {v_mix_0_interrupt, v_tpg_0_interrupt, v_frmbuf_wr_0_interrupt, v_frmbuf_rd_0_interrupt, v_tc_0_irq};
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        ...
        .I2C1_SCL_I(hdmi_ddc_scl_i),
        .I2C1_SCL_O(hdmi_ddc_scl_o),
        .I2C1_SCL_T(hdmi_ddc_scl_t),
        .I2C1_SDA_I(hdmi_ddc_sda_i),
        .I2C1_SDA_O(hdmi_ddc_sda_o),
        .I2C1_SDA_T(hdmi_ddc_sda_t),
  ...
  design_1_rst_ps7_0_150M_0 rst_ps7_0_150M
       (.aux_reset_in(1'b1),
        ...
        .ext_reset_in(processing_system7_0_FCLK_RESET0_N),
        .mb_debug_sys_rst(1'b0),
        .peripheral_aresetn(rst_ps7_0_150M_peripheral_aresetn1),
  ...
  design_1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S00_AXI_araddr(v_mix_0_m_axi_mm_video1_ARADDR),
        .S00_AXI_arburst(v_mix_0_m_axi_mm_video1_ARBURST),
        .S00_AXI_arcache(v_mix_0_m_axi_mm_video1_ARCACHE),
        .S00_AXI_arid(v_mix_0_m_axi_mm_video1_ARID),
        .S00_AXI_arlen(v_mix_0_m_axi_mm_video1_ARLEN),
        .S00_AXI_arlock(v_mix_0_m_axi_mm_video1_ARLOCK[0]),
        .S00_AXI_arprot(v_mix_0_m_axi_mm_video1_ARPROT),
        .S00_AXI_arqos(v_mix_0_m_axi_mm_video1_ARQOS),
        .S00_AXI_arready(v_mix_0_m_axi_mm_video1_ARREADY),
        .S00_AXI_arsize(v_mix_0_m_axi_mm_video1_ARSIZE),
        .S00_AXI_arvalid(v_mix_0_m_axi_mm_video1_ARVALID),
        .S00_AXI_awaddr(v_mix_0_m_axi_mm_video1_AWADDR),
        .S00_AXI_awburst(v_mix_0_m_axi_mm_video1_AWBURST),
        .S00_AXI_awcache(v_mix_0_m_axi_mm_video1_AWCACHE),
        .S00_AXI_awid(v_mix_0_m_axi_mm_video1_AWID),
        .S00_AXI_awlen(v_mix_0_m_axi_mm_video1_AWLEN),
        .S00_AXI_awlock(v_mix_0_m_axi_mm_video1_AWLOCK[0]),
        .S00_AXI_awprot(v_mix_0_m_axi_mm_video1_AWPROT),
        .S00_AXI_awqos(v_mix_0_m_axi_mm_video1_AWQOS),
        .S00_AXI_awready(v_mix_0_m_axi_mm_video1_AWREADY),
        .S00_AXI_awsize(v_mix_0_m_axi_mm_video1_AWSIZE),
        .S00_AXI_awvalid(v_mix_0_m_axi_mm_video1_AWVALID),
        .S00_AXI_bid(v_mix_0_m_axi_mm_video1_BID),
        .S00_AXI_bready(v_mix_0_m_axi_mm_video1_BREADY),
        .S00_AXI_bresp(v_mix_0_m_axi_mm_video1_BRESP),
        .S00_AXI_bvalid(v_mix_0_m_axi_mm_video1_BVALID),
        .S00_AXI_rdata(v_mix_0_m_axi_mm_video1_RDATA),
        .S00_AXI_rid(v_mix_0_m_axi_mm_video1_RID),
        .S00_AXI_rlast(v_mix_0_m_axi_mm_video1_RLAST),
        .S00_AXI_rready(v_mix_0_m_axi_mm_video1_RREADY),
        .S00_AXI_rresp(v_mix_0_m_axi_mm_video1_RRESP),
        .S00_AXI_rvalid(v_mix_0_m_axi_mm_video1_RVALID),
        .S00_AXI_wdata(v_mix_0_m_axi_mm_video1_WDATA),
        .S00_AXI_wlast(v_mix_0_m_axi_mm_video1_WLAST),
        .S00_AXI_wready(v_mix_0_m_axi_mm_video1_WREADY),
        .S00_AXI_wstrb(v_mix_0_m_axi_mm_video1_WSTRB),
        .S00_AXI_wvalid(v_mix_0_m_axi_mm_video1_WVALID),
        .S01_AXI_araddr(v_frmbuf_rd_0_m_axi_mm_video_ARADDR),
        .S01_AXI_arburst(v_frmbuf_rd_0_m_axi_mm_video_ARBURST),
        .S01_AXI_arcache(v_frmbuf_rd_0_m_axi_mm_video_ARCACHE),
        .S01_AXI_arlen(v_frmbuf_rd_0_m_axi_mm_video_ARLEN),
        .S01_AXI_arlock(v_frmbuf_rd_0_m_axi_mm_video_ARLOCK[0]),
        .S01_AXI_arprot(v_frmbuf_rd_0_m_axi_mm_video_ARPROT),
        .S01_AXI_arqos(v_frmbuf_rd_0_m_axi_mm_video_ARQOS),
        .S01_AXI_arready(v_frmbuf_rd_0_m_axi_mm_video_ARREADY),
        .S01_AXI_arsize(v_frmbuf_rd_0_m_axi_mm_video_ARSIZE),
        .S01_AXI_arvalid(v_frmbuf_rd_0_m_axi_mm_video_ARVALID),
        .S01_AXI_awaddr(v_frmbuf_rd_0_m_axi_mm_video_AWADDR),
        .S01_AXI_awburst(v_frmbuf_rd_0_m_axi_mm_video_AWBURST),
        .S01_AXI_awcache(v_frmbuf_rd_0_m_axi_mm_video_AWCACHE),
        .S01_AXI_awlen(v_frmbuf_rd_0_m_axi_mm_video_AWLEN),
        .S01_AXI_awlock(v_frmbuf_rd_0_m_axi_mm_video_AWLOCK[0]),
        .S01_AXI_awprot(v_frmbuf_rd_0_m_axi_mm_video_AWPROT),
        .S01_AXI_awqos(v_frmbuf_rd_0_m_axi_mm_video_AWQOS),
        .S01_AXI_awready(v_frmbuf_rd_0_m_axi_mm_video_AWREADY),
        .S01_AXI_awsize(v_frmbuf_rd_0_m_axi_mm_video_AWSIZE),
        .S01_AXI_awvalid(v_frmbuf_rd_0_m_axi_mm_video_AWVALID),
        .S01_AXI_bready(v_frmbuf_rd_0_m_axi_mm_video_BREADY),
        .S01_AXI_bresp(v_frmbuf_rd_0_m_axi_mm_video_BRESP),
        .S01_AXI_bvalid(v_frmbuf_rd_0_m_axi_mm_video_BVALID),
        .S01_AXI_rdata(v_frmbuf_rd_0_m_axi_mm_video_RDATA),
        .S01_AXI_rlast(v_frmbuf_rd_0_m_axi_mm_video_RLAST),
        .S01_AXI_rready(v_frmbuf_rd_0_m_axi_mm_video_RREADY),
        .S01_AXI_rresp(v_frmbuf_rd_0_m_axi_mm_video_RRESP),
        .S01_AXI_rvalid(v_frmbuf_rd_0_m_axi_mm_video_RVALID),
        .S01_AXI_wdata(v_frmbuf_rd_0_m_axi_mm_video_WDATA),
        ...
        .S02_AXI_arlock(v_frmbuf_wr_0_m_axi_mm_video_ARLOCK),
        ...
        .S02_AXI_awlock(v_frmbuf_wr_0_m_axi_mm_video_AWLOCK),
        ...
        .aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_150M_peripheral_aresetn1));
  design_1_v_axi4s_vid_out_0_0 v_axi4s_vid_out_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .aclken(ilconstant_0_dout),
        .aresetn(rst_ps7_0_150M_peripheral_aresetn1),
        .fid(ilconstant_2_dout),
        ...
        .vid_io_out_ce(ilconstant_0_dout),
        .vid_io_out_clk(axi_dynclk_0_PXL_CLK_O),
        .vid_io_out_reset(ilconstant_2_dout),
