...
input   HwReg_frm_buffer3_ap_vld;
...
wire   [63:0] AXIMMvideo2Bytes_U0_bytePlanes_plane2_din;
wire    AXIMMvideo2Bytes_U0_bytePlanes_plane2_write;
...
wire    Bytes2MultiPixStream_U0_bytePlanes_plane2_read;
...
wire    bytePlanes_plane2_full_n;
wire   [63:0] bytePlanes_plane2_dout;
wire    bytePlanes_plane2_empty_n;
wire   [9:0] bytePlanes_plane2_num_data_valid;
wire   [9:0] bytePlanes_plane2_fifo_cap;
wire    img_full_n;
wire   [23:0] img_dout;
wire    img_empty_n;
...
design_1_v_frmbuf_rd_0_0_fifo_w64_d481_B bytePlanes_plane0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_0_0_fifo_w64_d481_B bytePlanes_plane1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
design_1_v_frmbuf_rd_0_0_fifo_w64_d481_B bytePlanes_plane2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
